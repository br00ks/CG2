...
define(["jquery", "straight_line", "circle.js", "parametric_curve", "bezier_curve"], 
	...
	$("#inputRadius").change(function() {
       ...
       $("#functionY").change(function() {
		...
		try {
			//selectedObject.yt = eval($("#functionY").val());
       ...
       // if a point of the beziercurve is changed, the whole object will be removed of the
       // scene and a new beziercurve-object will be drawn
